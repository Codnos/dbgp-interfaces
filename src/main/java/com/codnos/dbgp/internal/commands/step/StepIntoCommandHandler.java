...
public final class StepIntoCommandHandler extends DBGpContinuationCommandHandler {

    private final StatusChangeHandlerFactory statusChangeHandlerFactory;

    public StepIntoCommandHandler(DebuggerEngine debuggerEngine, StatusChangeHandlerFactory statusChangeHandlerFactory, ArgumentConfiguration argumentConfiguration) {
    ...
    protected boolean canHandle(String msg) {
        return msg.startsWith("step_into");
    }

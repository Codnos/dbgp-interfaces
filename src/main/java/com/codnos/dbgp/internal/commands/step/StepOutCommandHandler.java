...
public final class StepOutCommandHandler extends DBGpContinuationCommandHandler {

    private final StatusChangeHandlerFactory statusChangeHandlerFactory;

    public StepOutCommandHandler(DebuggerEngine debuggerEngine, StatusChangeHandlerFactory statusChangeHandlerFactory, ArgumentConfiguration argumentConfiguration) {
    ...
    protected boolean canHandle(String msg) {
        return msg.startsWith("step_out");
    }

...
public class BreakNowResponse extends CommandResponse {

    public static boolean canBuildFrom(Document document) {
        return boolForXPath(document, "string(/dbgp:response/@command)='break'");
    }

    public BreakNowResponse(Document message) {
        super(message);
    }

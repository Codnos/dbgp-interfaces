...
public class BreakpointUpdateResponse extends CommandResponse {

    public static boolean canBuildFrom(Document document) {
        return boolForXPath(document, "string(/dbgp:response/@command)='breakpoint_update'");
    }

    public BreakpointUpdateResponse(Document message) {
        super(message);
    }
